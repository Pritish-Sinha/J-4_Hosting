...
class DUPX_Bootstrap
{
	...
	const ARCHIVE_FILENAME	 = '20211211_lonefotography_11cd9846d39636c51722_20211211163128_archive.zip';
	const ARCHIVE_SIZE		 = '133384985';
	const INSTALLER_DIR_NAME = 'dup-installer';
	const PACKAGE_HASH		 = '11cd984-11163128';
    const SECONDARY_PACKAGE_HASH = '7800f9b-11163128';
	const VERSION			 = '1.4.3';
